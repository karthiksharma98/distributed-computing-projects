...
ssh-copy-id -i /home/$1/.ssh/id_rsa.pub $1@fa20-cs425-g13-10.cs.illinois.edu
#
...
for val in fa20-cs425-g13-0{2..9}.cs.illinois.edu; do
	ssh $1@$val "rm -r /home/$1/hadoop-2.9.2/etc/hadoop/mapred-site.xml"
	scp ./mapred-site.xml $1@$val:/home/$1/hadoop-2.9.2/etc/hadoop
done

ssh $1@fa20-cs425-g13-10.cs.illinois.edu "rm -r /home/$1/hadoop-2.9.2/etc/hadoop/mapred-site.xml"
scp ./mapred-site.xml $1@fa20-cs425-g13-10.cs.illinois.edu:/home/$1/hadoop-2.9.2/etc/hadoop
...
echo 'datanode9' >> /home/$1/hadoop-2.9.2/etc/hadoop/slaves #10
# #
...
ssh $1@fa20-cs425-g13-10.cs.illinois.edu "rm -r /home/$1/hadoop-2.9.2"

rm -rf /home/$1/hadoop-2.9.2.tar.gz
tar -zcvf /home/$1/hadoop-2.9.2.tar.gz /home/$1/hadoop-2.9.2

scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-02.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-03.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-04.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-05.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-06.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-07.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-08.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-09.cs.illinois.edu:/home/$1
scp -r hadoop-2.9.2.tar.gz $1@fa20-cs425-g13-10.cs.illinois.edu:/home/$1

ssh $1@fa20-cs425-g13-02.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-03.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-04.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-05.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-06.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-07.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-08.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-09.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"
ssh $1@fa20-cs425-g13-10.cs.illinois.edu "tar -xvzf hadoop-2.9.2.tar.gz"



#
## Insert bash scripts to workers
cd /home/$1/cs425_mps/hadoop_configs
...
scp setup-bashrc.sh $1@fa20-cs425-g13-10.cs.illinois.edu:/home/$1
...
ssh $1@fa20-cs425-g13-10.cs.illinois.edu "sh /home/$1/setup-bashrc.sh $1" 
...
ssh $1@fa20-cs425-g13-10.cs.illinois.edu "mkdir -p /home/$1/hadoop_store/hdfs/datanode"
ssh $1@fa20-cs425-g13-10.cs.illinois.edu "mkdir -p /home/$1/hadoop_store/hdfs/namenode"
